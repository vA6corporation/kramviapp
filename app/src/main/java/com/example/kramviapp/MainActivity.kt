            ...
            LaunchedEffect(profile) {
                profile?.let {
                    ...
                    if (activeModule.openBox) {
                        if (user.activeModule["openBox"] == true || user.isAdmin) {
                            modules.add(
                                ModuleModel(
                                    name = "Estado de caja",
                    ...
                    if (activeModule.posStandard) {
                        if (user.activeModule["posStandard"] == true || user.isAdmin) {
                            modules.add(
                                ModuleModel(
                                    name = "Punto de venta",
                    ...
                    if (activeModule.posFood) {
                        if (user.activeModule["posFood"] == true || user.isAdmin) {
                            modules.add(
                                ModuleModel(
                                    name = "Punto de venta",
                                    drawable = Icons.Default.DesktopWindows,
                    ...
                    if (activeModule.proformar) {
                        if (user.activeModule["proformar"] == true || user.isAdmin) {
                            modules.add(
                                ModuleModel(
                                    name = "Proformar",
                                    drawable = Icons.Default.DesktopWindows,
                    ...
                    if (activeModule.proformas) {
                        if (user.activeModule["proformas"] == true || user.isAdmin) {
                            modules.add(
                                ModuleModel(
                                    name = "Proformas",
                    ...
                    if (activeModule.products) {
                        if (user.activeModule["products"] == true || user.isAdmin) {
                            modules.add(
                                ModuleModel(
                                    name = "Productos",
                    ...
                    if (activeModule.inventories) {
                        if (user.activeModule["inventories"] == true || user.isAdmin) {
                            modules.add(
                                ModuleModel(
                                    name = "Inventario",
                    ...
                    if (activeModule.sales) {
                        if (user.activeModule["sales"] == true || user.isAdmin) {
                            modules.add(
                                ModuleModel(
                                    name = "Comprobantes",
