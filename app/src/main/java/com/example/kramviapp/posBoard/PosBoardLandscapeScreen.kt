...
fun PosBoardLandscapeScreen(
                ...
                onSuccessRequest = {
                    ...
                    boardsViewModel.deleteBoardItem(
                        ...
                        onResponse = {
                            ...
                            boardItem.observation = selectedUpdateBoardItem.observation
    ...
    if (showSelectionAnnotationsDialog) {
        selectedProduct?.let { product ->
            SelectAnnotationsDialog(product) { observation ->
                observation?.let {
                    boardsViewModel.addBoardItem(product, observation)
                }
        ...
        BoardItemDialog(
            ...
            onDismissRequest = { updatedBoardItem ->
                if (updatedBoardItem != null) {
                    if (boardItem.id == 0 && updatedBoardItem.quantity < boardItem.quantity) {
    ...
    Row(
        ...
        Column(
            ...
            if (setting.defaultPrice == PriceType.LISTA || setting.defaultPrice == PriceType.LISTAOFICINA) {
                priceLists?.let { priceLists ->
                    ExposedDropdownMenuBox(
                        ...
                        priceLists.find { it.id == priceListId }?.let {
                            TextField(
                                readOnly = true,
                                value = it.name,
                                onValueChange = { },
            ...
            LazyColumn(
                ...
                itemsIndexed(boardItems) { index, boardItem ->
                    ListItem(
                        ...
                        supportingContent = {
                            Row(
                                ...
                                Text(text = boardItem.observation)
