...
class BuildInvoiceSharePdf(
    ...
    private fun buildPdf(): File {
        ...
        val invoiceTitle = when (sale.invoiceCode) {
            InvoiceCode.BOLETA -> "BOLETA ELECTRONICA"
            InvoiceCode.FACTURA -> "FACTURA ELECTRONICA"
            InvoiceCode.NOTA_DE_VENTA -> "NOTA DE VENTA"
        }
        ...
        val textBusinessName = Text(business.name.uppercase(Locale.getDefault()))
