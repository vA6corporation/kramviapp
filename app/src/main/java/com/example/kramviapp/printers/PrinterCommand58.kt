...
class PrinterCommand58(
    ...
    private fun buildBody(): StringBuilder {
        ...
        for (boardItem in boardItems) {
            body.append("[L]<font size='tall'>").append(boardItem.fullName.uppercase())
                .append("[R]").append(String.format("%.0f", boardItem.quantity)).append("</font>\n")
