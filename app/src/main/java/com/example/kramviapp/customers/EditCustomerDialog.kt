    ...
    Dialog(onDismissRequest = { }) {
        Card(
            ...
            customer?.let { customer ->
                var documentType by remember { mutableStateOf(customer.documentType) }
                var document by remember { mutableStateOf(customer.document) }
                                    ...
                                    if (document.isNotEmpty() && name.isNotEmpty()) {
                                        ...
                                        customersViewModel.updateCustomer(
                                            ...
                                            onResponse = {
                                                ...
                                                customersViewModel.setCustomer(updatedCustomer)
